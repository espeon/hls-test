var SubtitlesOctopus = function (options) {
  ...
  console.log("will resize on  timeoutf");
  ...
  self.createCanvas = function () {
    if (!self.canvas) {
      if (self.video) {
        console.log(self.video.parentNode.firstChild);
    ...
    if (self.video) {
      ...
      self.video.addEventListener(
        ...
        (e) => {
          ...
          console.log("fullscreen og v change");
        },
        false
      );
      ...
      document.addEventListener(
        ...
        (e) => {
          self.resizeWithTimeout();
          console.log("fullscreen og change");
        },
        false
      );
      document.addEventListener(
        ...
        (e) => {
          self.resizeWithTimeout();
          console.log("fullscreen moz change");
        },
        false
      );
      document.addEventListener(
        ...
        (e) => {
          ...
          console.log("fullscreen webkit change");
        },
        false
      );
      document.addEventListener(
        ...
        (e) => {
          self.resizeWithTimeout();
          console.log("fullscreen ms change");
        },
        false
      );
